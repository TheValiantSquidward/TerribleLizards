...
public class PteranodonModel extends ModModel<PteranodonEntity>  {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition tailopen = mainbody.addOrReplaceChild("tailopen", CubeListBuilder.create().texOffs(78, 0).addBox(-3.5F, 0.0F, -1.0F, 7.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 1.0F));
        ...
        PartDefinition rightwingback = rightwing.addOrReplaceChild("rightwingback", CubeListBuilder.create().texOffs(0, 37).addBox(0.0F, -1.75F, -5.0F, 0.0F, 18.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, -3.0F));
        ...
        PartDefinition righthand = rightforearm.addOrReplaceChild("righthand", CubeListBuilder.create().texOffs(20, 51).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 14.0F, 0.0F));

        PartDefinition rightfrontmembrane_open = rightforearm.addOrReplaceChild("rightfrontmembrane_open", CubeListBuilder.create().texOffs(20, 37).addBox(0.0F, 0.0F, -2.0F, 0.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightwingmiddle_open = rightforearm.addOrReplaceChild("rightwingmiddle_open", CubeListBuilder.create().texOffs(24, 36).addBox(0.0F, -7.0F, -1.75F, 0.0F, 14.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, 2.0F));
        ...
        PartDefinition rightwingtip_open = rightwingtip_control.addOrReplaceChild("rightwingtip_open", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -0.75F, 0.0F, 25.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightwingtip_folded = rightwingtip_control.addOrReplaceChild("rightwingtip_folded", CubeListBuilder.create().texOffs(24, 0).addBox(0.0F, 0.0F, -0.75F, 0.0F, 25.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition righttopmembrane_open = rightwing.addOrReplaceChild("righttopmembrane_open", CubeListBuilder.create().texOffs(74, 33).addBox(0.0F, -5.0F, -7.0F, 0.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -1.0F));
        ...
        PartDefinition leftwingback = leftwing.addOrReplaceChild("leftwingback", CubeListBuilder.create().texOffs(0, 37).mirror().addBox(0.0F, -1.75F, -5.0F, 0.0F, 18.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 3.0F, -3.0F));
        ...
        PartDefinition lefthand = leftforearm.addOrReplaceChild("lefthand", CubeListBuilder.create().texOffs(20, 51).mirror().addBox(-1.0F, 0.0F, 0.0F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 14.0F, 0.0F));

        PartDefinition leftfrontmembrane_open = leftforearm.addOrReplaceChild("leftfrontmembrane_open", CubeListBuilder.create().texOffs(20, 37).mirror().addBox(0.0F, 0.0F, -2.0F, 0.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leftwingmiddle_open = leftforearm.addOrReplaceChild("leftwingmiddle_open", CubeListBuilder.create().texOffs(24, 36).mirror().addBox(0.0F, -7.0F, -1.75F, 0.0F, 14.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 7.0F, 2.0F));
        ...
        PartDefinition leftwingtip_open = leftwingtip_control.addOrReplaceChild("leftwingtip_open", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, -0.75F, 0.0F, 25.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition leftwingtip_folded = leftwingtip_control.addOrReplaceChild("leftwingtip_folded", CubeListBuilder.create().texOffs(24, 0).mirror().addBox(0.0F, 0.0F, -0.75F, 0.0F, 25.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition lefttopmembrane_open = leftwing.addOrReplaceChild("lefttopmembrane_open", CubeListBuilder.create().texOffs(74, 33).mirror().addBox(0.0F, -5.0F, -7.0F, 0.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, -1.0F));
        ...
        PartDefinition rightlegwing_folded = rightleg.addOrReplaceChild("rightlegwing_folded", CubeListBuilder.create().texOffs(48, 48).addBox(0.0F, -11.0F, -9.0F, 0.0F, 11.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 6.0F, 0.0F));
        ...
        PartDefinition rightfoot = rightlegflapless.addOrReplaceChild("rightfoot", CubeListBuilder.create().texOffs(20, 56).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.0F, -1.0F));

        PartDefinition leftleg = leg_control.addOrReplaceChild("leftleg", CubeListBuilder.create(), PartPose.offset(3.25F, 0.0F, 0.0F));

        PartDefinition leftlegwing_folded = leftleg.addOrReplaceChild("leftlegwing_folded", CubeListBuilder.create().texOffs(48, 48).mirror().addBox(0.0F, -11.0F, -9.0F, 0.0F, 11.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.5F, 6.0F, 0.0F));
        ...
        PartDefinition leftfoot = leftlegflapless.addOrReplaceChild("leftfoot", CubeListBuilder.create().texOffs(20, 56).mirror().addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 10.0F, -1.0F));
